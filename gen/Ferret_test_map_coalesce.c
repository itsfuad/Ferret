...
// Module: Ferret/test_map_coalesce
...
#include "Ferret_test_map_coalesce.h"

int main() {
  ferret_map_t* capitals;
  const char* __map_keys_0[2];
  const char* __map_values_0[2];
  __map_keys_0[0] = "France";
  __map_values_0[0] = "Paris";
  __map_keys_0[1] = "Japan";
  __map_values_0[1] = "Tokyo";
  capitals = ferret_map_from_pairs(sizeof(const char*), sizeof(const char*), __map_keys_0, __map_values_0, 2, ferret_map_hash_str, ferret_map_equals_str);
